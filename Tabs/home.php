    ...
    <script>
        document.getElementById("employeeForm").addEventListener("submit", function(event) {
            ...
            if (empid === "" || isNaN(empid)) {
                document.getElementById("idError").textContent = "Valid Employee ID is required.";
                isValid = false;
            }
            ...
            if (empsalary === "" || isNaN(empsalary) || parseFloat(empsalary) <= 0) {
                document.getElementById("salaryError").textContent = "Enter a valid positive salary.";
                isValid = false;
            }
